...
iPhone 카메라 화면을 iPad, Mac 등 다른 기기에서 실시간으로 확인할 수 있습니다.

<!-- 이미지 추가: 미러링 화면 -->

### 원격 촬영

연결된 모든 기기에서 촬영 버튼을 눌러 원격으로 촬영할 수 있습니다.

<!-- 이미지 추가: 원격 촬영 화면 -->

### 타이머 촬영

8초 카운트다운 후 8초 간격으로 10장을 자동 촬영합니다.

<!-- 이미지 추가: 타이머 촬영 화면 -->

### 포즈 추천

촬영 시 다양한 포즈 가이드를 제공하여 자연스러운 촬영을 유도합니다.

<!-- 이미지 추가: 포즈 추천 화면 -->

### 포토 프레임 합성

촬영한 사진 중 원하는 사진을 선택하여 다양한 프레임에 합성하고 저장/공유할 수 있습니다.
