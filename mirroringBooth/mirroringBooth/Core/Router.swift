...
enum MirroringRoute: Hashable {
    case advertising
    case timerOrRemoteSelection(isRemoteEnable: Bool)
    case poseSuggestionSelection(isTimerMode: Bool)
    case streaming(isTimerMode: Bool, isPoseSuggestionEnabled: Bool)
    case captureResult
